...
void init(){
	...
	if(settings->get().notificationSounds){
		audio->play({
							Chirp{ .startFreq = 300, .endFreq = 600, .duration = 250 },
							Chirp{ .startFreq = 600, .endFreq = 300, .duration = 250 },
							Chirp{ .startFreq = 0, .endFreq = 0, .duration = 100 },
							Chirp{ .startFreq = 600, .endFreq = 600, .duration = 75 },
							Chirp{ .startFreq = 0, .endFreq = 0, .duration = 75 },
							Chirp{ .startFreq = 500, .endFreq = 500, .duration = 75 },
							Chirp{ .startFreq = 0, .endFreq = 0, .duration = 75 },
							Chirp{ .startFreq = 500, .endFreq = 500, .duration = 75 },
							Chirp{ .startFreq = 0, .endFreq = 0, .duration = 75 },
							Chirp{ .startFreq = 500, .endFreq = 500, .duration = 75 },
							Chirp{ .startFreq = 0, .endFreq = 0, .duration = 75 },
							Chirp{ .startFreq = 850, .endFreq = 850, .duration = 75 }
					});
	}
